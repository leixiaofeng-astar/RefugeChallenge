...
GlobalParams = collections.namedtuple('GlobalParams', [
    ...
    'drop_connect_rate', 'depth_divisor', 'min_depth', 'stem_stride'])
...
class Conv2dStaticSamePadding(nn.Conv2d):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, image_size=None, **kwargs):
        super(Conv2dStaticSamePadding, self).__init__(in_channels, out_channels, kernel_size, stride, **kwargs)
...
def efficientnet(width_coefficient=None, depth_coefficient=None, image_size=None,
                 dropout_rate=0.2, drop_connect_rate=0.2, num_classes=1000, stem_stride=2):
