...
Example:
    ...
    Run on GPU to convert torch GPU train model to CPU status
        $ python3 tools/ensemble.py --cfg experiments/refuge.yaml \
            --prevModelDir ../final-submission/model/ \
            --logDir ../final-submission/csv_table
            --release True
...
def main():
    ...
    csv_default_file = "fovea_location_results.csv"
    csv_location_dict = {'DS': './', 'ROI': './log', 'FINAL': './output/refuge/fovea_net/refuge',
                         'P2_DS': './', 'P2_ROI': './log', 'P2_FINAL': './output/refuge/fovea_net/refuge',
                         'HR_DS': './', 'HR_ROI': './log', 'HR_FINAL': './output/refuge/fovea_net/refuge',
    ...
    models_list = [
        ['checkpoint_0815_batch4_best723_P2.pth',
         # 'python tools/test.py --cfg experiments/refuge.yaml MODEL.SIGMA_ROI 2 MODEL.SIGMA 2 PRINT_FREQ 100', 'FINAL'],
         'python ../best_batch4_version/tools/test.py --cfg ../best_batch4_version/experiments/refuge.yaml WORKERS 0 PRINT_FREQ 100', 'P2_FINAL'],
        ['checkpoint_0819_epoch210_1200img_L099_P2.pth',
         # 'python tools/test.py --cfg experiments/refuge.yaml MODEL.SIGMA_ROI 2 MODEL.SIGMA 2 PRINT_FREQ 100', 'FINAL'],
         'python ../best_batch4_version/tools/test.py --cfg ../best_batch4_version/experiments/refuge.yaml WORKERS 0 PRINT_FREQ 100', 'P2_FINAL'],
        ['model_best_0813_716_P2.pth',
         # 'python tools/test.py --cfg experiments/refuge.yaml MODEL.SIGMA_ROI 2 MODEL.SIGMA 2 PRINT_FREQ 100', 'DS'],
         'python ../best_batch4_version/tools/test.py --cfg ../best_batch4_version/experiments/refuge.yaml WORKERS 0 PRINT_FREQ 100', 'P2_DS'],
        # ['model_best_0813_L69_P2.pth',
        #  'python ../best_batch4_version/tools/test.py --cfg ../best_batch4_version/experiments/refuge.yaml WORKERS 0 PRINT_FREQ 100', 'P2_DS'],
        ['checkpoint_HRNET_Aug26_1200img_E474_L159.pth',
         # 'python3.7 tools/test.py --cfg experiments/refuge.yaml WORKERS 0 PRINT_FREQ 100 TRAIN.HRNET_ONLY True', 'DS'],
         'python3.7 ../test_batch4/tools/test.py --cfg ../test_batch4/experiments/refuge.yaml WORKERS 0 PRINT_FREQ 100 TRAIN.HRNET_ONLY True', 'HR_DS'],
        ['checkpoint_HRNET_L737_Aug25.pth',
         # 'python3.7 tools/test.py --cfg experiments/refuge.yaml PRINT_FREQ 100 TRAIN.HRNET_ONLY True', 'DS'],
         'python3.7 ../test_batch4/tools/test.py --cfg ../test_batch4/experiments/refuge.yaml WORKERS 0 PRINT_FREQ 100 TRAIN.HRNET_ONLY True', 'HR_DS'],
        ['checkpoint_Hybrid_Aug28_L763_MV.pth',
         'python3.7 tools/test.py --cfg experiments/refuge.yaml WORKERS 0 TRAIN.MV_IDEA True PRINT_FREQ 100', 'DS'],
        ['checkpoint_Sep06_HM2and3_L771.pth',
         'python3.7 tools/test.py --cfg experiments/refuge.yaml WORKERS 0 MODEL.SIGMA_ROI 2 MODEL.SIGMA 3 PRINT_FREQ 100', 'ROI'] ]
    ...
    if len(fovea_location_groups) > 0:
        with open(master_csv_fullname, 'w') as f:
            ...
            # pd.merge(fovea_location_groups, on=['ImageName', 'Final_Fovea_X', 'Final_Fovea_Y'], how='right').to_csv(f, ignore_index=True)
...
if __name__ == '__main__':
    main()
    print("Refuge Fovea Ensemble Program Exit ... \n")
